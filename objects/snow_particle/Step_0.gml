...
if random_var = 1
{
	...
	{
	var set_x = irandom_range(xx-global.snow_effect_distance*100-abs(global.wind_dir)*64,xxx+global.snow_effect_distance*100+abs(global.wind_dir)*64)
	var set_y = (yy-camera_yscale/18)-global.snow_effect_distance*50
	
	var random_cre_obj = percentage_k(60)
	...
	random_cre_obj = 2
		...
		_rain_ef.direction = 270+global.wind_dir
