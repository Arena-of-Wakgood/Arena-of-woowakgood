...
draw_rectangle(xx-v_x*320,yy-v_x*260,xx+v_x*320,yy+v_x*64,false)

	for(var i = chat_line; i < 10+chat_line; i++) 
	{
	draw_text_kl_scale(xx-v_x*(320-16),yy+v_x*(-20-(i-chat_line)*24),chat[i],v_x*64,-1,1,c_white,0,-1,font0,v_x*0.4,v_x*0.4,0);
	}
