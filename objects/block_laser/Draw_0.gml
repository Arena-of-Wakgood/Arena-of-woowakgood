...
draw_set_color(color_)
draw_set_alpha(image_alpha*0.6)
draw_circle(x2,y2,1.9*width_*global.light_scaling*self_scaling*0.92,false)
...
draw_set_color(c_white)
draw_set_alpha(image_alpha*0.6)
draw_circle(x2,y2,1.5*width_*global.light_scaling*self_scaling*0.7,false)
...
draw_set_color(c_white)
draw_set_alpha(image_alpha*0.9)
draw_circle(x2,y2,1.5*width_*global.light_scaling*self_scaling*0.53,false)
